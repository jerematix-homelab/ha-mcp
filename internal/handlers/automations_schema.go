...
var automationSchema = struct {
	...
	Triggers: []automationSchemaType{
		{Type: "state", Description: "Fires when entity state changes", Required: []string{"entity_id"}, Optional: []string{"from", "to", "for", "attribute"}},
		{Type: "numeric_state", Description: "Fires when numeric value crosses threshold", Required: []string{"entity_id"}, Optional: []string{"above", "below", "for", "attribute", "value_template"}},
		...
		{Type: "zone", Description: "Fires when entity enters or leaves a zone", Required: []string{"entity_id", "zone", "event"}},
		...
		{Type: "calendar", Description: "Fires on calendar event start/end", Required: []string{"entity_id", "event"}, Optional: []string{"offset"}},
		{Type: "conversation", Description: "Fires when voice command matches", Required: []string{"command"}},
	},
	Conditions: []automationSchemaType{
		{Type: "state", Description: "Checks entity state or attribute", Required: []string{"entity_id", "state"}, Optional: []string{"attribute", "for", "match"}},
		{Type: "numeric_state", Description: "Checks numeric value against threshold", Required: []string{"entity_id"}, Optional: []string{"above", "below", "attribute", "value_template"}},
		...
		{Type: "zone", Description: "Checks if entity is in a zone", Required: []string{"entity_id", "zone"}},
